                ...
                <div class="col-md-4 mb-3">
                    <select class="custom-select" id="product_category" name="productCategory">
                        ...
                        @foreach($productCategories as $productCategorySelection)
                            <option value="{{ $productCategorySelection->id }}" @if( old('productCategory', $productCategory) == $productCategorySelection->id) selected @endif>{{ $productCategorySelection->name }}</option>
                        @endforeach
                    </select>
                </div>
                        ...
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="priceCompare" id="price-compare-gteq" value="gteq" checked="" @if( old('priceCompare', $priceCompare) == 'gteq') checked @endif>
                                    <label class="form-check-label" for="price-compare-gteq">以上</label>
                                </div>
                                <div class="form-check form-check-inline mr-0">
                                    <input class="form-check-input" type="radio" name="priceCompare" id="price-compare-lteq" value="lteq" @if( old('priceCompare', $priceCompare) == 'lteq') checked @endif>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <select class="custom-select" name="sort">
                        ...
                        <option value="product-category-asc" @if( old('sort', $sort) == "product-category-asc") selected @endif>並び替え: 商品カテゴリ昇順</option>
                        <option value="product-category-desc" @if( old('sort', $sort) == "product-category-desc") selected @endif>並び替え: 商品カテゴリ降順</option>
                        ...
                        <option value="price-asc" @if( old('sort', $sort) == "price-asc") selected @endif>並び替え: 価格昇順</option>
                        <option value="price-desc" @if( old('sort', $sort) == "price-desc") selected @endif>並び替え: 価格降順</option>
                    </select>
                </div>
                <div class="col-md-4 mb-3">
